...
public interface ResultAdapter<E> extends Comparable<ResultAdapter> {
    ...
    /**
     * Called to determine whether or not this adapter can adapt the original value passed down from a data store
     * operation to the type required by the repository method being invoked
     *
