...
public class DefaultRepositoryFactoryConfiguration implements RepositoryFactoryConfiguration {
    ...
    public DefaultRepositoryFactoryConfiguration(RepositoryFactoryConfiguration configuration) {
        this(configuration.getRepositoryMetadataResolver(), configuration.getDescriptionExtractor(),
             configuration.getFunctionRegistry(), configuration.getDataStoreRegistry(),
             configuration.getResultAdapterContext(), configuration.getTypeMappingContext(),
             configuration.getEventListenerContext(),
             configuration.getOperationInvocationHandler(), configuration.getDefaultKeyGenerator());
    }

    public DefaultRepositoryFactoryConfiguration(RepositoryMetadataResolver repositoryMetadataResolver,
