...
/**
 * This is the default, most basic implementation provided for a data store that stores entities in an in-memory {@link
 * java.util.Map map} by mapping entity keys to entities.
 *
