 ...
 * @since 1.0 (4/28/16)
 */
public class PagingAndSortingSupport {

    private static final Log log = LogFactory.getLog(PagingAndSortingSupport.class);
     ...
     */
    protected List sort(Collection entries, Sort sort) {
     ...
     */
    public Page page(Collection entries, Pageable pageable) {
        final List<?> all;
