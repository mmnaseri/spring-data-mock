...
public class SliceIterableResultAdapterTest {
    ...
    public void testAccepting() throws Exception {
        ...
        assertThat(adapter.accepts(new ImmutableInvocation(ReturnTypeSampleRepository.class.getMethod("findSlice"), new Object[]{}), new Object()), is(false));
        assertThat(adapter.accepts(new ImmutableInvocation(ReturnTypeSampleRepository.class.getMethod("findSlice"), new Object[]{}), new ArrayList<>()), is(true));
    }
    ...
    public void testAdapting() throws Exception {
        ...
        final Slice slice = adapter.adapt(new ImmutableInvocation(ReturnTypeSampleRepository.class.getMethod("findSlice"), new Object[]{}), originalValue);
