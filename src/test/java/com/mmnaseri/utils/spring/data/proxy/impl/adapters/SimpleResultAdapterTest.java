...
public class SimpleResultAdapterTest {
    ...
    public void testAccepting() throws Exception {
        ...
        assertThat(adapter.accepts(new ImmutableInvocation(Sample.class.getMethod("findObject"), new Object[]{}), new Object()), is(true));
        assertThat(adapter.accepts(new ImmutableInvocation(Sample.class.getMethod("findInteger"), new Object[]{}), new Object()), is(true));
    }
