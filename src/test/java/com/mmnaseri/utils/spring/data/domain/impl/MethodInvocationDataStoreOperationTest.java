...
public class MethodInvocationDataStoreOperationTest {
    ...
    public void testAccessingPrivateMethod() throws Exception {
        final MethodInvocationDataStoreOperation<Serializable, Object> operation = new MethodInvocationDataStoreOperation<>(new MappedClass(null), MappedClass.class.getDeclaredMethod("privateMethod"));
    ...
    public void testAccessingErrorThrowingMethod() throws Exception {
        final MethodInvocationDataStoreOperation<Serializable, Object> operation = new MethodInvocationDataStoreOperation<>(new MappedClass(null), MappedClass.class.getDeclaredMethod("errorThrowingMethod"));
        operation.execute(null, null, new ImmutableInvocation(null, new Object[]{}));
    }
    ...
    public void testCallingNormalMethod() throws Exception {
        ...
        final MethodInvocationDataStoreOperation<Serializable, Object> operation = new MethodInvocationDataStoreOperation<>(new MappedClass(value), MappedClass.class.getDeclaredMethod("validMethod"));
