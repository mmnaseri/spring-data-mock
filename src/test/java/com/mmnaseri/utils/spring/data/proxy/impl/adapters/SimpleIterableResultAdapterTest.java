...
public class SimpleIterableResultAdapterTest {
    ...
    public void testAdaptingEmptyCollection() throws Exception {
        ...
        final Object value = adapter.adapt(new ImmutableInvocation(ReturnTypeSampleRepository.class.getMethod("findOther"), null), Collections.emptyList());
    ...
    public void testAdaptingSingletonList() throws Exception {
        final SimpleIterableResultAdapter adapter = new SimpleIterableResultAdapter();
        final Object value = adapter.adapt(new ImmutableInvocation(ReturnTypeSampleRepository.class.getMethod("findOther"), null), Collections.singletonList(1));
    ...
    public void testAdaptingMultiItemList() throws Exception {
        final SimpleIterableResultAdapter adapter = new SimpleIterableResultAdapter();
        adapter.adapt(new ImmutableInvocation(ReturnTypeSampleRepository.class.getMethod("findOther"), null), Arrays.asList(1, 2, 3));
    }
    ...
    public void testAdaptingIncompatibleValue() throws Exception {
        final SimpleIterableResultAdapter adapter = new SimpleIterableResultAdapter();
        adapter.adapt(new ImmutableInvocation(ReturnTypeSampleRepository.class.getMethod("findInteger"), null), Collections.singletonList("hello"));
    }
    ...
    public void testAccepting() throws Exception {
        ...
        assertThat(adapter.accepts(new ImmutableInvocation(ReturnTypeSampleRepository.class.getMethod("findIterable"), new Object[]{}), new Object()), is(false));
        ...
        assertThat(adapter.accepts(new ImmutableInvocation(ReturnTypeSampleRepository.class.getMethod("findInteger"), new Object[]{}), new Object()), is(false));
        assertThat(adapter.accepts(new ImmutableInvocation(ReturnTypeSampleRepository.class.getMethod("findOther"), new Object[]{}), new ArrayList<>()), is(true));
        assertThat(adapter.accepts(new ImmutableInvocation(ReturnTypeSampleRepository.class.getMethod("findInteger"), new Object[]{}), new ArrayList<>()), is(true));
    }
