...
public interface Operator {
    ...
    /**
     * @return the number of operands this operator needs (besides the property on the entity). So, for instance, an
     * equality check would require <strong>1</strong> operand.
     */
    int getOperands();

    /**
     * @return the matcher taking care of checking whether or not the operator applies to the current entity
     */
    Matcher getMatcher();
